...
// Watch watch all persistentvolumeclaim resources.
//
...
// WatchByNamespace watch all persistentvolumeclaim resources in the specified namespace.
//
// Object as the parameter of addFunc, modifyFunc, deleteFunc:
//  * If Event.Type is Added or Modified: the new state of the object.
//  * If Event.Type is Deleted: the state of the object immediately before deletion.
...
// WatchByName watch a single persistentvolumeclaim reseource.
//
// Object as the parameter of addFunc, modifyFunc, deleteFunc:
//  * If Event.Type is Added or Modified: the new state of the object.
//  * If Event.Type is Deleted: the state of the object immediately before deletion.
...
func (h *Handler) WatchByName(name string, addFunc, modifyFunc, deleteFunc func(obj interface{})) error {
	...
	return h.watchPersistentVolumeClaim(listOptions, addFunc, modifyFunc, deleteFunc)
}

// WatchByLabel watch a single or multiple PersistentVolumeClaim resources selected by the label.
...
func (h *Handler) WatchByLabel(labels string, addFunc, modifyFunc, deleteFunc func(obj interface{})) error {
	return h.watchPersistentVolumeClaim(metav1.ListOptions{LabelSelector: labels, TimeoutSeconds: new(int64)},
		addFunc, modifyFunc, deleteFunc)
}

// WatchByField watch a single or multiple PersistentVolumeClaim resources selected by the field.
//
// Object as the parameter of addFunc, modifyFunc, deleteFunc:
//  * If Event.Type is Added or Modified: the new state of the object.
//  * If Event.Type is Deleted: the state of the object immediately before deletion.
...
// watchPersistentVolumeClaim watch persistentvolumeclaim resources according to listOptions.
func (h *Handler) watchPersistentVolumeClaim(listOptions metav1.ListOptions,
	...
	for {
		...
		// notified of the persistentvolumeclaim existence and current state.
