...
var (
	...
	ErrInvalidPathType   = errors.New("path data type must be string, []byte, *corev1.Secret, corev1.Secret, runtime.Object, *unstructured.Unstructured, unstructured.Unstructured or map[string]interface{}")
)
