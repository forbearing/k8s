...
// SecretInformer returns underlying SecretInformer which provides access to
// a shared informer and lister for secret.
func (h *Handler) SecretInformer() informerscore.SecretInformer {
	return h.informerFactory.Core().V1().Secrets()
}
...
// and delete event of k8s secret resource, respectively.
