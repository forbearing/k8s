...
var (
	...
	ErrInvalidPathType   = errors.New("path data type must be string, []byte, *rbacv1.Role, rbacv1.Role, runtime.Object, *unstructured.Unstructured, unstructured.Unstructured or map[string]interface{}")
)
