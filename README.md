...
`go get github.com/forbearing/k8s@v0.12.1`
...
- [ ] AutoVersion() find appropriate resource version for your current cluster and return a dynamic.Handler to create/update/apply/patch/delete/get/list/watch current k8s resources, for example: cronjob version is v1beta1 in k8s v1.19.x.
- [ ] ForVersion()
