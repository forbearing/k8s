...
func (h *Handler) WatchByName(name string, addFunc, modifyFunc, deleteFunc func(obj interface{})) error {
	...
	return h.watchReplicationController(listOptions, addFunc, modifyFunc, deleteFunc)
}

// WatchByLabel watch a single or multiple ReplicationController resources selected by the label.
...
func (h *Handler) WatchByLabel(labels string, addFunc, modifyFunc, deleteFunc func(obj interface{})) error {
	return h.watchReplicationController(metav1.ListOptions{LabelSelector: labels, TimeoutSeconds: new(int64)},
...
// watchReplicationController watch replicationcontroller resources according to listOptions.
func (h *Handler) watchReplicationController(listOptions metav1.ListOptions,
	...
	for {
		...
		// notified of the replicationcontroller existence and current state.
