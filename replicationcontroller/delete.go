...
// Delete deletes replicationcontroller from type string, []byte, *corev1.ReplicationController,
...
// DeleteFromUnstructured deletes replicationcontroller from map[string]interface{}.
