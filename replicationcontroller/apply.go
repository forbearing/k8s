...
// Apply applies replicationcontroller from type string, []byte, *corev1.ReplicationController,
...
// ApplyFromUnstructured applies replicationcontroller from map[string]interface{}.
func (h *Handler) ApplyFromUnstructured(u map[string]interface{}) (*corev1.ReplicationController, error) {
