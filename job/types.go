...
var (
	...
	ErrInvalidPathType   = errors.New("path data type must be string, []byte, *batchv1.Job, batchv1.Job, runtime.Object, *unstructured.Unstructured, unstructured.Unstructured or map[string]interface{}")
)
