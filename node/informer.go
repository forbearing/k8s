...
// NodeInformer returns underlying NodeInformer which provides access to a shared
// informer and lister for node.
func (h *Handler) NodeInformer() informerscore.NodeInformer {
	return h.informerFactory.Core().V1().Nodes()
}
...
// and delete event of k8s node resource, respectively.
