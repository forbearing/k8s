...
// Watch watch all replicaset resources.
//
...
// WatchByNamespace watch all replicaset resources in the specified namespace.
//
// Object as the parameter of addFunc, modifyFunc, deleteFunc:
//  * If Event.Type is Added or Modified: the new state of the object.
//  * If Event.Type is Deleted: the state of the object immediately before deletion.
...
// WatchByName watch a single replicaset reseource.
//
// Object as the parameter of addFunc, modifyFunc, deleteFunc:
//  * If Event.Type is Added or Modified: the new state of the object.
//  * If Event.Type is Deleted: the state of the object immediately before deletion.
...
func (h *Handler) WatchByName(name string, addFunc, modifyFunc, deleteFunc func(obj interface{})) error {
	...
	return h.watchReplicaSet(listOptions, addFunc, modifyFunc, deleteFunc)
}

// WatchByLabel watch a single or multiple ReplicaSet resources selected by the label.
...
func (h *Handler) WatchByLabel(labels string, addFunc, modifyFunc, deleteFunc func(obj interface{})) error {
	return h.watchReplicaSet(metav1.ListOptions{LabelSelector: labels, TimeoutSeconds: new(int64)},
		addFunc, modifyFunc, deleteFunc)
}

// WatchByField watch a single or multiple ReplicaSet resources selected by the field.
//
// Object as the parameter of addFunc, modifyFunc, deleteFunc:
//  * If Event.Type is Added or Modified: the new state of the object.
//  * If Event.Type is Deleted: the state of the object immediately before deletion.
...
// watchReplicaSet watch replicaset resources according to listOptions.
func (h *Handler) watchReplicaSet(listOptions metav1.ListOptions,
	...
	for {
		...
		// notified of the replicaset existence and current state.
