...
// GetFromFile gets networkpolicy from yaml or json file.
...
// GetFromBytes gets networkpolicy from bytes data.
...
// GetFromObject gets networkpolicy from metav1.Object or runtime.Object.
func (h *Handler) GetFromObject(obj interface{}) (*networkingv1.NetworkPolicy, error) {
